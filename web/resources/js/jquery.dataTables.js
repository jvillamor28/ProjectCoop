...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = '<label style="padding-bottom:20px;" class="fright">'+sSearchStr+'</label>';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			nLength.innerHTML = '<label style="padding-bottom:20px;" class="fleft">'+oSettings.oLanguage.sLengthMenu.replace( '_MENU_', sStdMenu )+'</label>';
